...
const ViewJob = () => {
  ...
  return (
    <div className=" bg-[#EEEEEF] h-full">
      ...
      <div className="grid grid-cols-8 w-[800px] mt-20">
        <div className="col-span-3">
          <div className="ml-8 text-base font-semibold pb-2">Job Details</div>
          <div className=" bg-white shadow-lg rounded-sm border border-[#C5C6C9] ml-8 mb-4 pl-5 pb-5 flex flex-col">
        ...
        <div className="col-span-5 ml-8">
          ...
          <div className="w-[800px] bg-white shadow-lg rounded-sm  pb-8 z-1">
