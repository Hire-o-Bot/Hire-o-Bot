...
const JobItemTileView = () => {
  ...
  return (
    <div>
      <div className='relative  h-[290px] bg-white shadow-lg rounded-sm border border-[#C5C6C9] pl-5 flex flex-col'>
        ...
        <div className='absolute bottom-0 left-0 pl-5 h-10 w-full bg-[#C5C6C9]'>
